...
import 'package:flutter_kiemtra/config/value.dart';
import 'package:flutter_kiemtra/model/news.dart';
import 'package:flutter_kiemtra/services/services.dart';
import 'package:flutter_kiemtra/view/showbody.dart';
...
class _BuidlWeblState extends State<BuidlWeb> {
 ...
 var image = [Value().imageTesla, Value().imageapple, Value().imagedomain];
  var str = ["Testla", "Apple", "Domains","Sources"];
  @override
  Widget build(BuildContext context) {
